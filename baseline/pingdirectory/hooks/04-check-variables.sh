...
if test "${ORCHESTRATION_TYPE}" == "KUBERNETES"; then
    echo_vars   K8S_CLUSTERS K8S_CLUSTER K8S_SEED_CLUSTER K8S_POD_INSTANCE_NAME_PREFIX K8S_POD_INSTANCE_NAME_SUFFIX K8S_SEED_INSTANCE_NAME_SUFFIX K8S_INCREMENT_PORTS
fi
